...
//            inputList.AddRange(VIRTUAL_KEY.LEFT.ToInputsPressKey());
//        inputList.AddRange(SendBackspaces(keyText.Length));
//        inputList.AddRange(replaceText.ToInputs());
//        if (triggerByEndingCharacter)
//            inputList.AddRange(VIRTUAL_KEY.RIGHT.ToInputsPressKey());
...
//        Enumerable.Repeat(VIRTUAL_KEY.BACK.ToInputsPressKey(), count).SelectMany(x => x).ToArray();
//}