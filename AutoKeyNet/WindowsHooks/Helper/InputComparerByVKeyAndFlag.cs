        ...
        return x.Type == y.Type
               && (
                   ...
                   || x.Type == InputType.INPUT_MOUSE && x.Data.MouseInput.Flags == y.Data.MouseInput.Flags
                                                       && (x.Data.MouseInput.MouseData >> 16 ) == (y.Data.MouseInput.MouseData >> 16));
    }

    public int GetHashCode(Input obj)
    {
        return HashCode.Combine((int)obj.Type,
            obj.Type == InputType.INPUT_KEYBOARD ? obj.Data.KeyboardInput.VirtualKey : (ushort)obj.Data.MouseInput.Flags,
            obj.Type == InputType.INPUT_KEYBOARD ? (int)obj.Data.KeyboardInput.Flags : obj.Data.MouseInput.MouseData);
    }
}